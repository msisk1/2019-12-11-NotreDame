...
venue: "The Cake Hutt"        # brief name of host site without address (e.g., "Euphoric State University")
address: "123 Fakerton Ave"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
instructor: ["Matthew Sisk", ""Walter Walterton] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Osgood Pettycoat"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
